...
function parseBlock(block: CodeBlock): McqInstrument | InvalidMcqBlock {
  ...
  const singles = [MCQ_FIELD_STEM, MCQ_FIELD_ANSWER, MCQ_FIELD_FEEDBACK, MCQ_FIELD_ID];
 ...
 * feedback and id. Human fields first and the machine field last, because the
 * form has to read well to someone typing it.
 *
